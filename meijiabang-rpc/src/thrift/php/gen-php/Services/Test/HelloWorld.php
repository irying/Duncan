...
class HelloWorldClient implements \Services\Test\HelloWorldIf
{
    ...
    {
        $args = new \Services\Test\HelloWorld_sayHello_args();
        $args->name = $name;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'sayHello', TMessageType::CALL, $args, $this->seqid_,
    ...
    public function recv_sayHello()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Services\Test\HelloWorld_sayHello_result',
            ...
            $result = new \Services\Test\HelloWorld_sayHello_result();
...
class HelloWorldProcessor
{
    ...
    protected function process_sayHello($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            thrift_protocol_write_binary($output, 'sayHello', TMessageType::REPLY, $result, $seqid,
